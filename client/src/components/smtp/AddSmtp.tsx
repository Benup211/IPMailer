...
export const AddSmtp = () => {
    const [host,setHost]=useState("");
    const [port,setPort]=useState("");
    const [username,setUsername]=useState("");
    const [password,setPassword]=useState("");
    const {increaseStat}=AuthState();
    const {isCreatingSmtp,addSmtpServer}=useSmtpStore();
    const navigate=useNavigate();
    const handleAddSmtpSubmit = async (
                ...
                >
                    <div className="max-w-xl">
                        ...
                        <div>
                            ...
                            >
                                {isCreatingSmtp? <Loader className="w-6 h-6 animate-spin  mx-auto" />:"Add Smtp Server"}
                            </button>
                        </div>
                    </div>
                </motion.form>
